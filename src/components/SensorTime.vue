<template lang="html">
  ...
  <!-- TIMER
      3333 : TIME 5506*, FRACTIONAL TIME 5507, appType 5750  -->
  <!-- if AM make a blue circle, if PM make a yellow circle -->
  <svg
    v-if="updatedSensor.type === 3333"
...
export default {
  ...
  data() {
    return {
      ...
      hands: [],
      colors: componentsSchemas.time.colors,
      aSide: true,
      months: [
        "Jan",
        "Feb",
