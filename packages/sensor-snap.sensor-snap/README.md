...
<script src="https://unpkg.com/sensor-snap.sensor-snap"></script>
<script>
new Vue({ el: '#app' })
</script>
```
...
<script src="https://unpkg.com/vue"></script>
<script src="https://unpkg.com/sensor-snap.sensor-snap/SensorSnap"></script>
<script>
new Vue({ el: '#app' })
</script>
```
...
```bash
npm install sensor-snap.sensor-snap
```

Then either import the library and either globally register all components with:

```js
import SensorSnap from 'sensor-snap.sensor-snap'
